defmodule PlugBenchPhoenix.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import PlugBenchPhoenix.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&PlugBenchPhoenix.ErrorHelpers.translate_error/1)
